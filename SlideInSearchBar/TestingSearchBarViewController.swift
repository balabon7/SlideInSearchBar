//
//  TestingSearchBarViewController.swift
//  SlideInSearchBar
//
...
////  CustomSearchBar2
////
////  Created by Oleksandr Balabon on 23.06.2024.
////
//
//import UIKit
//
...
//
//        // Update the frame of the search bar to match the width of the view with left and right padding of 25 points
//        self.searchBar.frame = CGRect(x: 25, y: 100, width: self.view.bounds.width - 50, height: 46)
//    }
//}
//
//// Custom search bar class
//public class CustomSearchBar: UIView, UITextFieldDelegate {
